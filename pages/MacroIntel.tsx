...
const REPORTS: MacroReport[] = [
  ...
  },
  {
    ...
    confidenceLevel: 'High',
    keyMetrics: [{"label":"US Core CPI (Annual)","value":"2.5%","direction":"down"},{"label":"Bitcoin","value":"$63,300","direction":"down"},{"label":"GSR SOL Allocation","value":"43.6%","direction":"up"},{"label":"Sept Hike Probability","value":"40%","direction":"down"}],
    keyInsights: ["The U.S. Consumer Price Index (CPI) printed a benign 3.4% annual rate, prompting traditional markets to aggressively scale back expectations for a September Federal Reserve rate hike.","Despite the dovish macroeconomic data, Bitcoin failed to rally, suppressed by a reported $90 million hardware wallet exploit that introduced sudden on-chain sell pressure.","Market maker GSR's decision to slash its Bitcoin allocation to 16.9% while elevating Solana (SOL) to 43.6% highlights a significant institutional rotation into higher-beta assets.","Capital allocators remain strictly defensive today, awaiting the Producer Price Index (PPI) release to confirm whether the disinflationary trend is structurally intact."],
    sections: [
      {
        icon: <Globe size={18} />,
        title: `Macro Context`,
        content: (<><p className="mb-4">The global macroeconomic landscape received a highly anticipated dovish signal yesterday as the U.S. Bureau of Labor Statistics released the July Consumer Price Index (CPI). Annual headline inflation cooled to <span className="text-emerald-400 font-bold">3.4%</span>, while the closely watched core inflation rate eased to <span className="text-emerald-400 font-bold">2.5%</span>. This benign data effectively derailed the hawkish narrative that had dominated early August trading, prompting futures markets to slash the probability of a September Federal Reserve interest rate hike to approximately <span className="text-emerald-400 font-bold">40%</span>.</p><p className="mb-4">However, the digital asset market's reaction was notably asymmetric. Instead of tracking the relief rally seen in traditional equities, Bitcoin remained anchored near the $63,300 level. This decoupling suggests that idiosyncratic, crypto-native headwinds are currently overpowering broader macroeconomic tailwinds. Specifically, localized sell pressure from a severe hardware wallet exploit and shifting institutional capital flows have completely absorbed any risk-on momentum generated by the CPI print.</p></>), 
      },
      {
        icon: <TrendingUp size={18} />,
        title: `Transmission Analysis`,
        content: (<><div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6"><div className="p-4 bg-surface border border-border rounded-xl"><h4 className="text-sm font-bold text-primary mb-2">Channel 1: Disinflationary Relief</h4><p className="text-xs text-text-muted">The easing of core CPI to <span className="text-emerald-400 font-bold">2.5%</span> fundamentally weakens the Federal Reserve's mandate to maintain rates in the <span className="text-emerald-400 font-bold">3.50%</span>–<span className="text-emerald-400 font-bold">3.75%</span> band, theoretically lowering the opportunity cost of holding non-yielding digital assets.</p></div><div className="p-4 bg-surface border border-border rounded-xl"><h4 className="text-sm font-bold text-primary mb-2">Channel 2: Institutional Rotation</h4><p className="text-xs text-text-muted">GSR's highly publicized portfolio rebalancing (cutting BTC to <span className="text-emerald-400 font-bold">16.9%</span> and overweighting SOL to <span className="text-emerald-400 font-bold">43.6%</span>) acts as a bellwether for institutional sentiment, demonstrating a clear preference for high-beta ecosystem growth over stagnant large-cap store-of-value narratives.</p></div><div className="p-4 bg-surface border border-border rounded-xl"><h4 className="text-sm font-bold text-primary mb-2">Channel 3: Exploit Surcharge</h4><p className="text-xs text-text-muted">The $90 million hardware wallet vulnerability introduces a physical security risk premium to the market, temporarily suppressing retail self-custody accumulation and forcing on-chain liquidation of compromised assets.</p></div></div></>), 
      },
      {
        icon: <Eye size={18} />,
        title: `What Professional Investors Are Watching`,
        content: (<><ul className="space-y-4 mb-4"><li className="flex items-start gap-3"><span className="w-2 h-2 rounded-full bg-primary mt-2 flex-shrink-0" /><div><strong className="text-text">Producer Price Index (PPI):</strong><span className="text-text-muted"> Scrutinizing today's wholesale inflation data to confirm or refute yesterday's dovish consumer inflation narrative.</span></div></li><li className="flex items-start gap-3"><span className="w-2 h-2 rounded-full bg-primary mt-2 flex-shrink-0" /><div><strong className="text-text">Institutional Flow Rotation:</strong><span className="text-text-muted"> Monitoring whether other tier-one market makers follow GSR's lead in rotating out of Bitcoin and into high-beta smart contract platforms like Solana.</span></div></li><li className="flex items-start gap-3"><span className="w-2 h-2 rounded-full bg-primary mt-2 flex-shrink-0" /><div><strong className="text-text">Hardware Wallet Post-Mortem:</strong><span className="text-text-muted"> Awaiting technical clarity on the exploit vector to determine the absolute scale of the vulnerability and its remaining on-chain sell pressure.</span></div></li><li className="flex items-start gap-3"><span className="w-2 h-2 rounded-full bg-primary mt-2 flex-shrink-0" /><div><strong className="text-text">FOMC Minutes Preparation:</strong><span className="text-text-muted"> Positioning portfolios ahead of the August 19 release of the July FOMC minutes for granular insights into the Fed's internal policy debates.</span></div></li></ul></>), 
      },
      {
        icon: <BarChart3 size={18} />,
        title: `Scenario Analysis`,
        content: (<><p className="mb-4"><strong>Base Case (60% probability):</strong> Today's PPI aligns with the dovish CPI data, establishing a solid macro floor. However, Bitcoin remains capped below $65,000 due to institutional rotation and exploit overhang.</p><p className="mb-4"><strong>Bull Case (25% probability):</strong> PPI prints significantly below expectations, forcing a rapid unwinding of hawkish Fed bets and triggering a broad crypto rally that drags BTC back toward $67,000.</p><p className="mb-4"><strong>Bear Case (15% probability):</strong> PPI data unexpectedly spikes, contradicting the CPI narrative. The dual pressure of macro tightening and crypto-native sell flow pushes Bitcoin through structural support at $62,000.</p></>), 
      },
    ]
  },
  {
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        icon: <Eye size={18} />,
        title: `What Professional Investors Are Watching`,
        content: (<><ul className="space-y-4 mb-4"><li className="flex items-start gap-3"><span className="w-2 h-2 rounded-full bg-primary mt-2 flex-shrink-0" /><div><strong className="text-text">Testimony Signals:</strong><span className="text-text-muted"> Federal Reserve Chair Kevin Warsh's upcoming congressional testimony for signals on balance sheet policy and inflation tolerance.</span></div></li><li className="flex items-start gap-3"><span className="w-2 h-2 rounded-full bg-primary mt-2 flex-shrink-0" /><div><strong className="text-text">Energy Market Volatility:</strong><span className="text-text-muted"> Supply disruptions in the Strait of Hormuz impacting global crude pricing.</span></div></li><li className="flex items-start gap-3"><span className="w-2 h-2 rounded-full bg-primary mt-2 flex-shrink-0" /><div><strong className="text-text">European Liquidity Consolidation:</strong><span className="text-text-muted"> The rapid consolidation of European liquidity as non-MiCA compliant exchanges suspend operations following the July 1 deadline.</span></div></li><li className="flex items-start gap-3"><span className="w-2 h-2 rounded-full bg-primary mt-2 flex-shrink-0" /><div><strong className="text-text">ETF Inflow Resilience:</strong><span className="text-text-muted"> The continuation of positive inflows into U.S. spot Bitcoin ETFs, which have shown resilience despite broader market fear.</span></div></li></ul></>), 
      },
      {
        icon: <BarChart3 size={18} />,
        title: `Scenario Analysis`,
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        icon: <Eye size={18} />,
        title: `What Professional Investors Are Watching`,
        content: (<><ul className="space-y-4 mb-4"><li className="flex items-start gap-3"><span className="w-2 h-2 rounded-full bg-primary mt-2 flex-shrink-0" /><div><strong className="text-text">Fed Guidance Shift:</strong><span className="text-text-muted"> Moving away from explicit forward guidance toward data-dependent flexibility.</span></div></li><li className="flex items-start gap-3"><span className="w-2 h-2 rounded-full bg-primary mt-2 flex-shrink-0" /><div><strong className="text-text">Energy Inflation:</strong><span className="text-text-muted"> Energy market volatility and its passthrough effect on the upcoming CPI print.</span></div></li><li className="flex items-start gap-3"><span className="w-2 h-2 rounded-full bg-primary mt-2 flex-shrink-0" /><div><strong className="text-text">Regulatory Integration:</strong><span className="text-text-muted"> Circle's OCC approval for a National Trust, indicating deeper regulatory integration for stablecoin infrastructure.</span></div></li><li className="flex items-start gap-3"><span className="w-2 h-2 rounded-full bg-primary mt-2 flex-shrink-0" /><div><strong className="text-text">RWA Tokenization Volume:</strong><span className="text-text-muted"> Tracking volume, particularly in tokenized U.S. Treasuries which remain the dominant asset class.</span></div></li></ul></>), 
      },
      {
        icon: <BarChart3 size={18} />,
        title: `Scenario Analysis`,
